package com.fit.web.fhdb.sqledit;
...
public class SQLeditController extends BaseController {
    ...
    public ModelAndView view() throws Exception {
        ...
        logBefore(log, Jurisdiction.getUsername() + "进入SQL编辑页面");
        if (!Jurisdiction.buttonJurisdiction(menuUrl, "cha")) {
            return null;
    ...
    public Object executeQuery() {
        logBefore(log, Jurisdiction.getUsername() + "执行查询语句");
        if (!Jurisdiction.buttonJurisdiction(menuUrl, "cha")) {
            return null;
        } //校验权限
    ...
    public Object executeUpdate() {
        logBefore(log, Jurisdiction.getUsername() + "执行更新语句");
