package com.fit.web.fhdb.timingbackup;
...
import com.fit.common.quartz.QuartzManager;
...
public class TimingBackUpController extends BaseController {
    ...
    public ModelAndView save() throws Exception {
        logBefore(log, Jurisdiction.getUsername() + "新增TimingBackUp");
        if (!Jurisdiction.buttonJurisdiction(menuUrl, "add")) {
            return null;
        }        //校验权限
        ModelAndView mv = this.getModelAndView();
        PageData pd = this.getPageData();
        String JOBNAME = pd.getString("TABLENAME") + "_" + getRandomNum();    //任务名称
    ...
    public void delete(PrintWriter out) throws Exception {
        logBefore(log, Jurisdiction.getUsername() + "删除TimingBackUp");
    ...
    public ModelAndView edit() throws Exception {
        logBefore(log, Jurisdiction.getUsername() + "修改TimingBackUp");
    ...
    public ModelAndView list(Page page) throws Exception {
        logBefore(log, Jurisdiction.getUsername() + "列表TimingBackUp");
    ...
    public Object deleteAll() throws Exception {
        logBefore(log, Jurisdiction.getUsername() + "批量删除TimingBackUp");
        if (!Jurisdiction.buttonJurisdiction(menuUrl, "del")) {
            return null;
        } //校验权限
        PageData pd = this.getPageData();
    ...
    public Object changeStatus() throws Exception {
        logBefore(log, Jurisdiction.getUsername() + "切换状态");
        if (!Jurisdiction.buttonJurisdiction(menuUrl, "edit")) {
            return null;
        } //校验权限
        PageData pd = this.getPageData();
    ...
    public ModelAndView exportExcel() throws Exception {
        logBefore(log, Jurisdiction.getUsername() + "导出TimingBackUp到excel");
