package com.fit.web.fhoa.department;
...
public class DepartmentController extends BaseController {
    ...
    public ModelAndView save() throws Exception {
        logBefore(log, Jurisdiction.getUsername() + "新增department");
    ...
    public Object delete(@RequestParam String DEPARTMENT_ID) throws Exception {
        ...
        logBefore(log, Jurisdiction.getUsername() + "删除department");
    ...
    public ModelAndView edit() throws Exception {
        logBefore(log, Jurisdiction.getUsername() + "修改department");
    ...
    public ModelAndView list(Page page) throws Exception {
        logBefore(log, Jurisdiction.getUsername() + "列表department");
        ModelAndView mv = this.getModelAndView();
        PageData pd = null;
        pd = this.getPageData();
    ...
    public ModelAndView listAllDepartment(Model model, String DEPARTMENT_ID) throws Exception {
        ...
        pd = this.getPageData();
        try {
            JSONArray arr = FastJsonUtil.objParseJsonArray(departmentService.listAllDepartment("0"));
