package com.fit.web.information.attached;
...
public class AttachedController extends BaseController {
    ...
    public ModelAndView save() throws Exception {
        logBefore(log, Jurisdiction.getUsername() + "新增Attached");
    ...
    public Object delete() throws NumberFormatException, Exception {
        logBefore(log, Jurisdiction.getUsername() + "删除Attached");
    ...
    public ModelAndView edit() throws Exception {
        logBefore(log, Jurisdiction.getUsername() + "修改Attached");
    ...
    public ModelAndView list(Page page) throws Exception {
        logBefore(log, Jurisdiction.getUsername() + "列表Attached");
    ...
    public Object deleteAll() throws Exception {
        logBefore(log, Jurisdiction.getUsername() + "批量删除Attached");
        if (!Jurisdiction.buttonJurisdiction(menuUrl, "del")) {
            return null;
        } //校验权限
    ...
    public ModelAndView exportExcel() throws Exception {
        logBefore(log, Jurisdiction.getUsername() + "导出Attached到excel");
