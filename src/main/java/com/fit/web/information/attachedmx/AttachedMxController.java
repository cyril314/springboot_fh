package com.fit.web.information.attachedmx;
...
public class AttachedMxController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		logBefore(log, Jurisdiction.getUsername()+"新增AttachedMx");
	...
	public void delete(PrintWriter out) throws Exception{
		logBefore(log, Jurisdiction.getUsername()+"删除AttachedMx");
	...
	public ModelAndView edit() throws Exception{
		logBefore(log, Jurisdiction.getUsername()+"修改AttachedMx");
	...
	public ModelAndView list(Page page) throws Exception{
		logBefore(log, Jurisdiction.getUsername()+"列表AttachedMx");
	...
	public Object deleteAll() throws Exception{
		logBefore(log, Jurisdiction.getUsername()+"批量删除AttachedMx");
	...
	public ModelAndView exportExcel() throws Exception{
		logBefore(log, Jurisdiction.getUsername()+"导出AttachedMx到excel");
