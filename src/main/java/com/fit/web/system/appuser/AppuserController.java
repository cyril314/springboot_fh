package com.fit.web.system.appuser;
...
public class AppuserController extends BaseController {
	...
	public ModelAndView saveU() throws Exception{
		if(!Jurisdiction.buttonJurisdiction(menuUrl, "add")){return null;} //校验权限
		logBefore(log, Jurisdiction.getUsername()+"新增会员");
		ModelAndView mv = this.getModelAndView();
		PageData pd = null;
		pd = this.getPageData();
	...
	public void deleteU(PrintWriter out) throws Exception{
		...
		logBefore(log, Jurisdiction.getUsername()+"删除会员");
		PageData pd = null;
		pd = this.getPageData();
	...
	public ModelAndView editU(PrintWriter out) throws Exception{
		...
		logBefore(log, Jurisdiction.getUsername()+"修改会员");
		ModelAndView mv = this.getModelAndView();
		PageData pd = null;
		pd = this.getPageData();
	...
	public Object deleteAllU() {
		...
		logBefore(log, Jurisdiction.getUsername()+"批量删除会员");
		PageData pd = new PageData();
	...
	public ModelAndView exportExcel(){
		logBefore(log, Jurisdiction.getUsername()+"导出会员资料");
		ModelAndView mv = this.getModelAndView();
		PageData pd = null;
		pd = this.getPageData();
		try{
