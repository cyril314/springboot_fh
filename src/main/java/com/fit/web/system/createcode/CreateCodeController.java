package com.fit.web.system.createcode;
...
import com.fit.common.utils.FileZip;
import com.fit.util.*;
...
public class CreateCodeController extends BaseController {
    ...
    public void proCode(HttpServletResponse response) throws Exception {
        ...
        logBefore(log, Jurisdiction.getUsername() + "执行代码生成器");
        PageData pd = null;
        pd = this.getPageData();
        save(pd);    //保存到数据库
        /* ============================================================================================= */
    ...
    public void delete(PrintWriter out) throws Exception {
        logBefore(log, Jurisdiction.getUsername() + "删除CreateCode");
    ...
    public Object deleteAll() throws Exception {
        logBefore(log, Jurisdiction.getUsername() + "批量删除CreateCode");
