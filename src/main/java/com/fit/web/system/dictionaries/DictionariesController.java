package com.fit.web.system.dictionaries;
...
public class DictionariesController extends BaseController {
    ...
    public ModelAndView save() throws Exception {
        logBefore(log, Jurisdiction.getUsername() + "新增Dictionaries");
    ...
    public Object delete(@RequestParam String DICTIONARIES_ID) throws Exception {
        ...
        logBefore(log, Jurisdiction.getUsername() + "删除Dictionaries");
    ...
    public ModelAndView edit() throws Exception {
        logBefore(log, Jurisdiction.getUsername() + "修改Dictionaries");
    ...
    public ModelAndView list(Page page) throws Exception {
        logBefore(log, Jurisdiction.getUsername() + "列表Dictionaries");
        ModelAndView mv = this.getModelAndView();
        PageData pd = null;
        pd = this.getPageData();
    ...
    public ModelAndView listAllDict(Model model, String DICTIONARIES_ID) throws Exception {
        ...
        pd = this.getPageData();
        try {
            JSONArray arr = FastJsonUtil.objParseJsonArray(dictionariesService.listAllDict("0"));
