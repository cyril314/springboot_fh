package com.fit.web.system.fhbutton;
...
public class FhbuttonController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		logBefore(log, Jurisdiction.getUsername()+"新增Fhbutton");
	...
	public void delete(PrintWriter out) throws Exception{
		logBefore(log, Jurisdiction.getUsername()+"删除Fhbutton");
	...
	public ModelAndView edit() throws Exception{
		logBefore(log, Jurisdiction.getUsername()+"修改Fhbutton");
	...
	public ModelAndView list(Page page) throws Exception{
		logBefore(log, Jurisdiction.getUsername()+"列表Fhbutton");
		ModelAndView mv = this.getModelAndView();
		PageData pd = null;
		pd = this.getPageData();
	...
	public Object deleteAll() throws Exception{
		logBefore(log, Jurisdiction.getUsername()+"批量删除Fhbutton");
	...
	public ModelAndView exportExcel() throws Exception{
		logBefore(log, Jurisdiction.getUsername()+"导出Fhbutton到excel");
