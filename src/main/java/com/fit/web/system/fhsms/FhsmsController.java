package com.fit.web.system.fhsms;
...
public class FhsmsController extends BaseController {
	...
	public Object save() throws Exception{
		logBefore(log, Jurisdiction.getUsername()+"发送站内信");
	...
	public void delete(PrintWriter out) throws Exception{
		logBefore(log, Jurisdiction.getUsername()+"删除Fhsms");
	...
	public ModelAndView list(Page page) throws Exception{
		logBefore(log, Jurisdiction.getUsername()+"列表Fhsms");
	...
	public Object deleteAll() throws Exception{
		logBefore(log, Jurisdiction.getUsername()+"批量删除Fhsms");
