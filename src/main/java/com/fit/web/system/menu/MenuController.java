package com.fit.web.system.menu;
...
public class MenuController extends BaseController {
    ...
    public ModelAndView add(Menu menu) throws Exception {
        ...
        logBefore(log, Jurisdiction.getUsername() + "保存菜单");
        ModelAndView mv = this.getModelAndView();
        PageData pd = null;
        pd = this.getPageData();
        try {
    ...
    public Object delete(@RequestParam String MENU_ID) throws Exception {
        ...
        logBefore(log, Jurisdiction.getUsername() + "删除菜单");
    ...
    public ModelAndView edit(Menu menu) throws Exception {
        ...
        logBefore(log, Jurisdiction.getUsername() + "修改菜单");
        ModelAndView mv = this.getModelAndView();
        try {
    ...
    public ModelAndView editicon() throws Exception {
        ...
        logBefore(log, Jurisdiction.getUsername() + "修改菜单图标");
        ModelAndView mv = this.getModelAndView();
        PageData pd = new PageData();
        try {
            pd = this.getPageData();
    ...
    public ModelAndView listAllMenu(Model model, String MENU_ID) throws Exception {
        ModelAndView mv = this.getModelAndView();
        try {
            JSONArray arr = FastJsonUtil.objParseJsonArray(menuService.listAllMenu("0"));
    ...
    public ModelAndView otherlistMenu(Model model, String MENU_ID) throws Exception {
        ...
        try {
            ...
            JSONArray arr = FastJsonUtil.objParseJsonArray(athmenuList);
            String json = arr.toString();
