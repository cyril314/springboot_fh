package com.fit.web.system.role;
...
public class RoleController extends BaseController {
    ...
    public ModelAndView add() throws Exception {
        ...
        logBefore(log, Jurisdiction.getUsername() + "新增角色");
        ModelAndView mv = this.getModelAndView();
        PageData pd = new PageData();
        try {
            pd = this.getPageData();
    ...
    public ModelAndView edit() throws Exception {
        ...
        logBefore(log, Jurisdiction.getUsername() + "修改角色");
        ModelAndView mv = this.getModelAndView();
        PageData pd = new PageData();
        try {
            pd = this.getPageData();
    ...
    public Object deleteRole(@RequestParam String ROLE_ID) throws Exception {
        ...
        logBefore(log, Jurisdiction.getUsername() + "删除角色");
    ...
    public ModelAndView listAllMenu(Model model, String ROLE_ID) throws Exception {
        ...
        try {
            ...
            JSONArray arr = FastJsonUtil.objParseJsonArray(menuList);
    ...
    public void saveMenuqx(@RequestParam String ROLE_ID, @RequestParam String menuIds, PrintWriter out) throws Exception {
        ...
        logBefore(log, Jurisdiction.getUsername() + "修改菜单权限");
        PageData pd = new PageData();
        try {
    ...
    public void saveB4Button(@RequestParam String ROLE_ID, @RequestParam String menuIds, @RequestParam String msg, PrintWriter out) throws Exception {
        ...
        logBefore(log, Jurisdiction.getUsername() + "修改" + msg + "权限");
        PageData pd = null;
        pd = this.getPageData();
        try {
            if (null != menuIds && !"".equals(menuIds.trim())) {
