...
(function (a, b) {
    ...
    "getBoundingClientRect" in c.documentElement ? d.fn.offset = function (a) {
            ...
            if (k.position === "relative" || k.position === "assets") l += i.offsetTop,
            m += i.offsetLeft;
    ...
    d.offset = {
            ...
            setOffset: function (a, b, c) {
                ...
                e === "assets" && (a.style.position = "relative");
                var f = d(a),
                    g = f.offset(),
                    h = d.css(a, "top"),
                    i = d.css(a, "left"),
    ...
    d.fn.extend({
            ...
            offsetParent: function () {
                return this.map(function () {
                    ...
                    while (a && (!cf.test(a.nodeName) && d.css(a, "position") === "assets")) a = a.offsetParent;
                    return a
                })
            }
        }),
