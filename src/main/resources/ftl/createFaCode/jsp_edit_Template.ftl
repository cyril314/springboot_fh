...
<c:if test="${r"${'edit' == msg }"}">
	<div>
		<iframe name="treeFrame" id="treeFrame" frameborder="0" src="${ctx}/${objectNameLower}mx/list.do?${objectNameUpper}_ID=${r"${pd."}${objectNameUpper}_ID${r"}"}" style="margin:0 auto;width:805px;height:368px;;"></iframe>
	</div>
</c:if>
