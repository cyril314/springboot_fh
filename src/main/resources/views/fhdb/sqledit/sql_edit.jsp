	...
	<script type="text/javascript">
		...
		function executeUpdate(){
			...
			if("" == sql){
			 ...
			 $.ajax({
					type: "POST",
					url: '${ctx}sqledit/executeUpdate.do?tm='+new Date().getTime(),
			    	data: {sql:sql},
					dataType:'json',
	...
	<script type="text/javascript">
		...
		function executeQuery(){
			...
			if("" == sql){
			 ...
			 $.ajax({
					type: "POST",
					url: '${ctx}sqledit/executeQuery.do?tm='+new Date().getTime(),
			    	data: {sql:sql},
					dataType:'json',
					//beforeSend: validateData,
					cache: false,
		...
		function toExcel(){
			...
			if("" == sqlstrforExcel){
				...
				window.location.href='${ctx}sqledit/excel.do?sql='+sqlstrforExcel;
			}
		}
	</script>
	</c:if>
