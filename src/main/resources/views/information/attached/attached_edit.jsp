	...
	<div class="main-content">
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
					<form action="/attached/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="FDESCRIBE" id="FDESCRIBE" value="${pd.FDESCRIBE}" maxlength="255" placeholder="这里输入描述" title="描述" style="width:98%;"/></td>
							</tr>
							<tr>
						...
						<div id="zhongxin2" class="center" style="display:none"><br/><br/><br/><br/><br/><img src="/assets/images/jiazai.gif" /><br/><h4 class="lighter block green">提交中...</h4></div>
					</form>
					</div>
					<!-- /.col -->
				</div>
...
<c:if test="${msg == 'edit' }">
	<div>
		<iframe name="treeFrame" id="treeFrame" frameborder="0" src="${ctx}/attachedmx/list.do?ATTACHED_ID=${pd.ATTACHED_ID}" style="margin:0 auto;width:805px;height:368px;;"></iframe>
	</div>
</c:if>
