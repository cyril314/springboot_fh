 	...
 	<script type="text/javascript">
		...
		function delUser(userId,msg){
			bootbox.confirm("确定要删除["+msg+"]吗?", function(result) {
				if(result) {
					top.jzts();
					var url = "${ctx}happuser/deleteU.do?USER_ID="+userId+"&tm="+new Date().getTime();
		...
		function toExcel(){
			...
			window.location.href='${ctx}happuser/excel.do?keywords='+keywords+'&lastLoginStart='+lastLoginStart+'&lastLoginEnd='+lastLoginEnd+'&ROLE_ID='+ROLE_ID+'&STATUS='+STATUS;
		}
		</script>
</html>
