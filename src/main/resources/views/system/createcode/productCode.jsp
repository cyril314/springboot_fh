...
<div class="main-container" id="main-container">
	...
	<div class="main-content">
		...
		<form action="createCode/proCode.do" name="Form" id="Form" method="post">
			...
			<div id="zhongxin2" class="center" style="display:none"><br/><br/><br/><br/><img src="/assets/images/jiazai.gif" /><br/><h4 class="lighter block green"><strong id="second_show">10秒</strong></h4></div>
		</form>
	</div>
	<!-- /.main-content -->
</div>
...
<script src="/assets/js/myjs/productCode.js"></script>
