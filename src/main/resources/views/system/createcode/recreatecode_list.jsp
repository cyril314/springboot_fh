...
<body class="no-skin">
	...
	<script type="text/javascript">
		...
		function connDb() {
			...
			$.ajax({
				type: "POST",
				url: '${ctx}recreateCode/listAllTable.do?tm=' + new Date().getTime(),
		...
		function productCode(table) {
			...
			diag.Drag = true;
			diag.Title = "代码生成器";
			diag.URL = '${ctx}recreateCode/goProductCode.do?table=' + table + '&dbtype=' + dbtype + '&dbAddress=' + dbAddress + '&dbport=' + dbport + '&username=' + username + '&password=' + password + '&databaseName=' + databaseName;
			diag.Width = 800;
			diag.Height = 500;
