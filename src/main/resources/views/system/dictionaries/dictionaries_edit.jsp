		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<div id="zhongxin2" class="center" style="display:none"><img src="/assets/images/jzx.gif" style="width: 50px;" /><br/><h4 class="lighter block green"></h4></div>
					</div>
					<!-- /.col -->
				</div>
				<!-- /.row -->
...
<script type="text/javascript">
	...
	function hasBianma() {
		...
		$.ajax({
			type: "POST",
			url: '${ctx}dictionaries/hasBianma.do',
