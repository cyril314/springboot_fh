...
<body class="no-skin">
	...
	<div class="main-container" id="main-container">
		...
		<div id="zhongxin2" class="center" style="display:none"><br/><img src="/assets/images/jzx.gif" id='msg' /><br/><h4 class="lighter block green" id='msg'>正在发送...</h4><strong id="second_shows" class="red">6秒</strong>后关闭</div>
	</div>
		<!-- /.main-content -->
	</div>
	<!-- /.main-container -->
...
<!-- 编辑框-->
<!--引入属于此页面的js -->
<script type="text/javascript" src="/assets/js/myjs/headEmail.js"></script>
<!--提示框-->
