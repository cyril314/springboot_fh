...
<script type="text/javascript" src="/assets/ace/js/jquery.js"></script>
...
<!--引入属于此页面的js -->
<script type="text/javascript" src="/assets/js/myjs/sys.js"></script>
<!--提示框-->
							  ...
							  <div id="profile" class="tab-pane">
								...
								<table id="table_report" class="table table-striped table-bordered table-hover">
									...
									<tr>
										...
										<td colspan="10">
										<div style="float:left;"><img src="${ctx}uploadFiles/uploadImgs/${pd.imgUrl}"  width="100"/></div>
							  ...
							  <div id="profile3" class="tab-pane">
								...
								<table id="table_report" class="table table-striped table-bordered table-hover">
									...
									<tr>
										...
										<td><input type="text" name="WXURL" id="WXURL" value="${ctx}weixin/index " disabled="disabled"  style="width:90%" title="URL(服务器地址)必须是域名，ip地址验证通不过"/></td>
									</tr>
									<tr>
