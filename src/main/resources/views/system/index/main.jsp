				...
				<div class="row">
					<div id="jzts" style="display:none; width:100%; position:fixed; z-index:99999999;">
						...
						<div style="padding-left: 70%;padding-top: 1px;">
							<div style="float: left;margin-top: 3px;"><img src="/assets/images/loadingi.gif" /> </div>
...
<!--引入属于此页面的js -->
<script type="text/javascript" src="/assets/js/myjs/head.js"></script>
<!--引入属于此页面的js -->
<script type="text/javascript" src="/assets/js/myjs/index.js"></script>
<!--引入弹窗组件start-->
