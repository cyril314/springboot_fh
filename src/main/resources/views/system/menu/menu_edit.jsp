			...
			<div class="page-content">
				...
				<div class="row">
					...
					<form  action="menu/${MSG }.do" name="menuForm" id="menuForm" method="post" class="form-horizontal">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="menuName"> 名称 :</label>
							<div class="col-sm-9">
								<input type="text" name="MENU_NAME" id="menuName" value="${pd.MENU_NAME }" placeholder="这里输入菜单名称" class="col-xs-10 col-sm-5" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="menuUrl"> 链接  :</label>
							<div class="col-sm-9">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="menuOrder"> 序号 : </label>
							<div class="col-sm-9">
						...
						<c:if test="${'0' == MENU_ID}">
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-radio1"> 类型 : </label>
							<div class="col-sm-9">
...
<script type="text/javascript">
	...
	function goback(MENU_ID){
		top.jzts();
		window.location.href="${ctx}menu.do?MENU_ID="+MENU_ID;
	}
