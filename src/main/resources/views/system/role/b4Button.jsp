			...
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						...
						<div id="zhongxin2" class="center" style="display:none"><br/><br/><br/><br/><img src="/assets/images/jiazai.gif" /><br/><h4 class="lighter block green">正在保存...</h4></div>
						</div>
					<!-- /.col -->
					</div>
				</div>
...
<script type="text/javascript">
	...
	function save() {
		...
		var msg = "${msg}";
		var ROLE_ID = "${ROLE_ID}";
		var url = "${ctx}role/saveB4Button.do";
		var postData;
