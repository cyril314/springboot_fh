				...
				<div class="row">
					<div class="col-xs-12">
						...
						<div id="zhongxin2" class="center" style="display:none">
							<br/><br/><br/><br/><img src="/assets/images/jiazai.gif" /><br/><h4 class="lighter block green">正在保存...</h4>
						</div>
					<!-- /.col -->
					</div>
				</div>
...
<script type="text/javascript">
	...
	function save() {
		...
		var postData = {"ROLE_ID": "${ROLE_ID}", "menuIds": ids};
		$("#zhongxin").hide();
		$("#zhongxin2").show();
		$.post("${ctx}role/saveMenuqx.do", postData, function (data) {
			top.Dialog.close();
		});
	}
</script>
