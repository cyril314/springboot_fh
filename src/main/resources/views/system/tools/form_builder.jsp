...
<div class="main-container" id="main-container">
                                                            ...
                                                            <div class="ibox-content">
                                                                ...
                                                                <form class="form-horizontal m-t">
                                                                    ...
                                                                    <div class="form-group draggable">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                            <input type="password" id="form-field-1" placeholder="请输入密码"
                                                                    ...
                                                                    <div class="form-group draggable">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                            <input class="span10 date-picker" name="name" id="id" value="" type="text"
                                                                                   data-date-format="yyyy-mm-dd" readonly="readonly" style="width:150px;"
                                                    ...
                                                    <div class="col-sm-7" style="width:100%;">
                                                        <div class="ibox float-e-margins">
                                                            ...
                                                            <div class="ibox-content">
                                                                ...
                                                                <button type="submit" class="btn btn-warning" data-clipboard-text="testing"
                                                                        id="copy-to-clipboard">查看代码
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <form action="${ctx}/tool/downloadFormCode.do" name="Form" id="Form" method="post">
