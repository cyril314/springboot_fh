									...
									<div class="step-content row-fluid position-relative" style="padding-top: 10px;">
										<div style="float: left;">
											<span class="input-icon">
												<input type="text" id="serverUrl" title="输入请求地址" value="${ctx}/appuser/getAppuserByUm.do?USERNAME=a1" style="width:540px;">
...
<!--引入属于此页面的js -->
<script type="text/javascript" src="/assets/js/myjs/interfaceTest.js"></script>
