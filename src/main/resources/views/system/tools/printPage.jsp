...
<head>
    ...
    <script language="javascript" src="/assets/js/jquery.jqprint-0.3.js"></script>
</head>
<body>
<div id="zhongxin">
...
<div id="zhongxin2" class="center" style="display:none">
    <br/><br/><br/><br/><br/><img src="/assets/images/jiazai.gif" /><br/><h4 class="lighter block green">提交中...</h4>
</div>
<!-- 引入 -->
<script type="text/javascript">window.jQuery || document.write("<script src='assets/js/jquery-1.9.1.min.js'>\x3C/script>");</script>
