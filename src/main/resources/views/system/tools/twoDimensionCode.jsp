								...
								<div class="widget-box">
									...
									<div class="widget-body">
									 <div class="widget-main">
										<img id="encoderImgId" cache="false" src="${ctx}assets/images/default.png" width="261px" height="261px;"/>
									 </div><!--/widget-main-->
									</div><!--/widget-body-->
								</div><!--/widget-box-->
							 </div><!--/span-->
...
<!--引入属于此页面的js -->
<script type="text/javascript" src="/assets/js/myjs/readTwoD.js"></script>
<script type="text/javascript">
	$(top.hangge());
</script>
</body>
