							...
							<table style="width:95%;" >
								...
								<tr>
									<td style="text-align: center;padding-top: 10px;">
										...
										<a class="btn btn-mini btn-success" onclick="window.location.href='${ctx}/user/downExcel.do'">下载模版</a>
									</td>
								</tr>
							</table>
							</div>
							<div id="zhongxin2" class="center" style="display:none"><br/><img src="/assets/images/jzx.gif" /><br/><h4 class="lighter block green"></h4></div>
						</form>
					</div>
					<!-- /.col -->
				</div>
